...
public class EmpRepositoryMybatis implements EmpRepository {
    ...
    public Emp save(Emp emp)              { /* insert/update — Day 9 */ return emp; }
    public void deleteById(Long id)       { /* Day 9 */ }
}
```
...
public class EmpServiceImpl implements EmpService {
    ...
    public List<Emp> findAll() {
        return empMapper.findAll();          // 부서명 조인은 Day 9
    }
    ...
    // register/modify/remove 는 Day 9
}
```
