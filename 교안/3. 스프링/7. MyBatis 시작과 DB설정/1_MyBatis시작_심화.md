# Day 7. MyBatis 시작 & DB 설정 — 심화 (경험자용)
...
- `@MybatisTest`(슬라이스) 또는 `@SpringBootTest` + `@Transactional`(자동 롤백)로 실제 DB 검증(Day 8).
