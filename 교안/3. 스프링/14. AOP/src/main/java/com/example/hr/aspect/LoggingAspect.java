...
/**
 * Day 14 — 서비스/컨트롤러 메서드의 실행 시간·인자·반환값을 자동 로깅하는 애스펙트.
 * build.gradle 에 spring-boot-starter-aop 필요.
 * @Aspect + @Component 둘 다 있어야 동작한다.
 *
 * 본문 5절의 serviceLayer() 단독 버전에 실습답안 문제 2의 controllerLayer() 를 더한
 * 가장 완전한 버전(원래 이 챕터 폴더에 느슨하게 있던 파일을 aspect 패키지로 옮김).
 */
@Slf4j
@Aspect
@Component
